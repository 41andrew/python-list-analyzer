...
class TestCsvDataLoader(unittest.TestCase):
    ...
    def test_read_lines_from_file_file_not_exists(self):
        ...
        self.assertRaises(FileNotFoundError, self.data_loader.read_lines_from_file("key_for_invalid_path"))
    ...
    def test_parse_object_from_semicolon_separated_line_wrong_formatting_bda(self):
        ...
        self.assertRaises(IndexError,
                          self.data_loader.parse_object_from_semicolon_separated_line(line, "input_file_bda"))
    ...
    def test_parse_object_from_semicolon_separated_line_wrong_formatting_engagement(self):
        ...
        self.assertRaises(IndexError,
                          self.data_loader.parse_object_from_semicolon_separated_line(line, "input_file_engagements"))
    ...
    def test_parse_object_from_semicolon_separated_line_wrong_formatting_proposal(self):
        ...
        self.assertRaises(TypeError,
                          self.data_loader.parse_object_from_semicolon_separated_line(line, "input_file_proposals"))
